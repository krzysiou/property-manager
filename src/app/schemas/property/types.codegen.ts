...
export namespace PropertyModule {
  interface DefinedFields {
    WeatherData: 'observationTime' | 'temperature' | 'weatherCode' | 'windSpeed' | 'windDegree' | 'windDir' | 'pressure' | 'precip' | 'humidity' | 'cloudcover' | 'feelslike' | 'uvIndex' | 'visibility';
    Property: 'id' | 'city' | 'street' | 'state' | 'zipCode' | 'weatherData' | 'lat' | 'lon' | 'creationDate';
  ...
  export type WeatherData = Pick<Types.WeatherData, DefinedFields['WeatherData']>;
  ...
  export type PropertiesWithPageInfo = Pick<Types.PropertiesWithPageInfo, DefinedFields['PropertiesWithPageInfo']>;
  export type Query = Pick<Types.Query, DefinedFields['Query']>;
  export type Mutation = Pick<Types.Mutation, DefinedFields['Mutation']>;
  
  export type WeatherDataResolvers = Pick<Types.WeatherDataResolvers, DefinedFields['WeatherData'] | '__isTypeOf'>;
  export type PropertyResolvers = Pick<Types.PropertyResolvers, DefinedFields['Property'] | '__isTypeOf'>;
  export type PageInfoResolvers = Pick<Types.PageInfoResolvers, DefinedFields['PageInfo'] | '__isTypeOf'>;
  export type PropertiesWithPageInfoResolvers = Pick<Types.PropertiesWithPageInfoResolvers, DefinedFields['PropertiesWithPageInfo'] | '__isTypeOf'>;
